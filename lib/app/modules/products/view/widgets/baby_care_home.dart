...
class HomeBabyCareSection extends GetView<ProductController> {
  const HomeBabyCareSection({super.key});

  static const int _babyCareCategoryId = 11;

  @override
  Widget build(BuildContext context) {
    return Obx(() {
      final loading = controller.isHomeSectionLoading.value;
      final products = controller.babyCareProducts;
        ...
        child: Column(
          ...
          children: [
            _SectionHeader(
              title: "Baby care",
              onSeeAllTap: () {
                controller.openCategoryWiseProducts(_babyCareCategoryId);
              },
            ),
