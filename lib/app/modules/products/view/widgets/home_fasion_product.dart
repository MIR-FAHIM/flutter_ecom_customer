// lib/app/modules/home/widgets/home_featured_products_section.dart
...
class HomeFashionSection extends GetView<ProductController> {
  const HomeFashionSection({super.key});

  @override
  Widget build(BuildContext context) {
    return Obx(() {
      final loading = controller.isHomeSectionLoading.value;
      final products = controller.fashionProducts;
