// lib/app/modules/products/view/widgets/medicine_home.dart
...
class HomeMedicineSection extends GetView<ProductController> {
  const HomeMedicineSection({super.key});

  static const int _medicineCategoryId = 348;

  @override
  Widget build(BuildContext context) {
    return Obx(() {
      final loading = controller.isHomeSectionLoading.value;
      final products = controller.medicineProducts;

      if (loading && products.isEmpty) {
        return const _MedicineSkeleton();
      }
        ...
        child: Column(
          ...
          children: [
            _SectionHeader(
              title: "Medicine",
              onSeeAllTap: () {
                controller.openCategoryWiseProducts(_medicineCategoryId);
              },
            ),
