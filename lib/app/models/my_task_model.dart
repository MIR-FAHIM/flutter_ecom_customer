...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    important: json["Important"] == null ? []:List<Important>.from(json["Important"].map((x) => Important.fromJson(x))),
    low: json["Low"] == null ? []:List<Important>.from(json["Low"].map((x) => Important.fromJson(x))),
    medium:json["Medium"] == null ? []: List<Important>.from(json["Medium"].map((x) => Important.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "Important": List<dynamic>.from(important!.map((x) => x.toJson())),
    "Low": List<dynamic>.from(low!.map((x) => x.toJson())),
...
class Important {
  ...
  factory Important.fromJson(Map<String, dynamic> json) => Important(
    id: json["id"],
